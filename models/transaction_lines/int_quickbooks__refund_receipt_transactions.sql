...
final as (
    ...
    select
        ...
        refund_receipt_lines.amount * coalesce(-refund_receipts.exchange_rate, -1) as amount,
        refund_receipts.total_amount * coalesce(-refund_receipts.exchange_rate, -1) as total_amount
